view: fact_allctn_holdng_historical {
  derived_table: {
    ...
    WITH product_asset_allocation_percentage AS  -- All products get an asset allocation percentage per allocation code
      ...
      hld.NK_HK_DIM_REGSTR_REPRSNTTV NK_HK_DIM_REGSTR_REPRSNTTV,
      ...
      Allocation_Agg as
      (   SELECT FARM_FINGERPRINT(ARRAY_TO_STRING(['ID', CAST(fct.NK_HK_DIM_ACCNT AS STRING),CAST(fct.NK_HK_DIM_REGSTR_REPRSNTTV AS STRING), fct.PRODCT_SYMBL,fct.PRODCT_DESC,fct.ALLOCATION_CODE,fct.ALLOCATION_NAME],'-','null')) AS ID,
      fct.NK_HK_DIM_ACCNT,
      fct.NK_HK_DIM_REGSTR_REPRSNTTV,
      fct.PRODCT_SYMBL,
      fct.PRODCT_DESC,
      fct.ALLOCATION_CODE,
