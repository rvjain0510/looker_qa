# This view is created for 1276440-adjustment-to-firm-reporting no dim user api explore
view: dim_houshld_accnt_pdt_no_dim_user_api {
  derived_table:
  {
    sql: Select
          ...
          on rep.NK_HK_DIM_REGSTR_REPRSNTTV = dim_regstr_reprsnttv.MD_HASH_NAT_KEYS and dim_regstr_reprsnttv.MD_ACTIVE
          ...
          -- added the following condition for 1276440-adjustment-to-firm-reporting
          WHERE dim_regstr_reprsnttv.REP_CODE <> 'SEAA' AND NOT REGEXP_CONTAINS(accnt.account_number,r'^[A-Z][A-Z]')
          GROUP BY 1,2,7;;
